...
public class JwtUtils {
    ...
    // Clé secrète (Symétrique). En production, mets ça dans application.properties
    private static final String SECRET_KEY = "TaCleSecreteTresLonguePourTerrabiaM1SIGLProjet2025ChangeMoiVite";

    // EXIGENCE : Durée de session de 30 jours
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + EXPIRATION_TIME)) // 30 jours
                .signWith(getSignInKey(), SignatureAlgorithm.HS256) // Algorithme Symétrique
                .compact();
    }
